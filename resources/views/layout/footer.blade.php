<div class="footer_container">
        ...
        <footer class="footer row row-cols-1 row-cols-md-3 row-cols-lg-4 g-5 g-md-3">
            <div class="col">
                ...
                <p class="footer_short_text">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veritatis incidunt quia alias minima omnis voluptas
                </p>
            </div>
            ...
            <div class="col footer_links_container">
                ...
                <a class="d-flex gap-2 align-items-center footer_links_item" href="#">
                    <div>
                        <svg height="16px" widht="16px" fill='#fff' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
                    </div>
                    support@manvirgroup.com
                </a>
                <a class="d-flex gap-2 align-items-center footer_links_item" href="#">
                    <div>
    ...
    <hr class="mt-4 mb-0 mt-lg-0 mx-auto footer_seperator">
    <div class="container max-width footer_bottom">
        <p class="text-white">Copyright &copy; 2024 - All Rights Reserved</p>
        <a class="" href="#">Get Started &rarr;</a>
    </div>
</div>
